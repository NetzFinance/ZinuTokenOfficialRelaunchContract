...
import "./Zodiac.sol";
import "./IZRC20.sol";
import "./MainnetzGasCollector.sol";

contract DividendWrappedNativeDistributor is IDividendDistributor, Zodiac {
    ...
    constructor() {
        _token = msg.sender;
        RewardToken = IWNETZ(router.WETH());
    }
